...
export const BasketSummary: React.FC<BasketSummaryProps> = ({ id }) => {
  const { isCartOpen, toggleCartVisibility, cart, checkout } =
  ...
  return (
    <div hidden={!isCartOpen}>
      <section id={id} className={styles["basket-summary"]} role="dialog">
            ...
            <table className={styles["basket-summary__table"]}>
              <thead>
                <tr className={styles["basket-summary__table-head"]}>
                  <th className={styles["basket-summary__table-head-data"]}>
                    Product
                  </th>
                  <th className={styles["basket-summary__table-head-data"]}>
                    Price
                  ...
                  <th
                    className={styles["basket-summary__table-head-data"]}
                  ></th>
                </tr>
              </thead>
              <tbody>
        ...
        <button
          className={styles["basket-summary__close-btn"]}
      ...
      <div
        className={styles["basket-overlay"]}
        aria-hidden="true"
        onClick={toggleCartVisibility}
      ></div>
    </div>
